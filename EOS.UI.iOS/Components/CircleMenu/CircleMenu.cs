    ...
    public class CircleMenu : UIView
    {
        ...
        void CreateMenuButtons()
        {
            ...
            for (int i = 0; i < _source.Count; ++i)
            {
                ...
                ///TODO need to remove
                menuButton.SetTitle(_source[i].Id.ToString(), UIControlState.Normal);
                menuButton.SetTitleColor(UIColor.Black, UIControlState.Normal);
                menuButton.TouchUpInside += (sender, e) => _source[i].Clicked?.Invoke(menuButton, EventArgs.Empty);
        ...
        void ShowMenuButtons()
        {
            ...
            //UIView.Animate(5, 0, UIViewAnimationOptions.TransitionCrossDissolve, () =>
            //{
