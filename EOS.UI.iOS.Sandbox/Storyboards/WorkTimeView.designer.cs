...
namespace EOS.UI.iOS.Sandbox
{
    ...
    partial class WorkTimeView
    {
        ...
        [Outlet]
        EOS.UI.iOS.Sandbox.EOSSandboxDropDown titleColorDropDown { get; set; }
        ...
        [Outlet]
        EOS.UI.iOS.Components.WorkTimeCalendarCollection workTimeCollection { get; set; }
        ...
        void ReleaseDesignerOutlets ()
        {
            ...
            if (titleColorDropDown != null) {
                titleColorDropDown.Dispose ();
                titleColorDropDown = null;
            }
