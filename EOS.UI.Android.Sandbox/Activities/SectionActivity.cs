...
namespace EOS.UI.Android.Sandbox.Activities
{
    ...
    public class SectionActivity : BaseActivity
    {
        ...
        private SendboxDropDown _sectionNameDropDown;
        private SendboxDropDown _buttonTextDropDown;
        private SendboxDropDown _sectionFontDropDown;
        private SendboxDropDown _buttonFontDropDown;
        private SendboxDropDown _sectionNameLetterSpacingDropDown;
        private SendboxDropDown _buttonTextLetterSpacingDropDown;
        private SendboxDropDown _sectionTextSizeDropDown;
        private SendboxDropDown _buttonTextSizeDropDown;
        private SendboxDropDown _sectionTextColorDropDown;
        private SendboxDropDown _buttonTextColorDropDown;
        private SendboxDropDown _backgroundColorDropDown;
        private SendboxDropDown _borderColorDropDown;
        private SendboxDropDown _borderWidthDropDown;
        private SendboxDropDown _paddingTopDropDown;
        private SendboxDropDown _paddingBottomDropDown;
        private SendboxDropDown _paddingLeftDropDown;
        private SendboxDropDown _paddingRightDropDown;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            _sectionNameDropDown = FindViewById<SendboxDropDown>(Resource.Id.sectionNameDropDown);
            _buttonTextDropDown = FindViewById<SendboxDropDown>(Resource.Id.buttonTextDropDown);
            _sectionFontDropDown = FindViewById<SendboxDropDown>(Resource.Id.sectionNameFontDropDown);
            _buttonFontDropDown = FindViewById<SendboxDropDown>(Resource.Id.buttonTextFontDropDown);
            _sectionNameLetterSpacingDropDown = FindViewById<SendboxDropDown>(Resource.Id.sectionNameLetterSpacingDropDown);
            _buttonTextLetterSpacingDropDown = FindViewById<SendboxDropDown>(Resource.Id.buttonTextLetterSpacingDropDown);
            _sectionTextSizeDropDown = FindViewById<SendboxDropDown>(Resource.Id.sectionTextSizeDropDown);
            _buttonTextSizeDropDown = FindViewById<SendboxDropDown>(Resource.Id.buttonTextSizeDropDown);
            _sectionTextColorDropDown = FindViewById<SendboxDropDown>(Resource.Id.sectionTextColorDropDown);
            _buttonTextColorDropDown = FindViewById<SendboxDropDown>(Resource.Id.buttonTextColorDropDown);
            _backgroundColorDropDown = FindViewById<SendboxDropDown>(Resource.Id.backgroundColorDropDown);
            _borderColorDropDown = FindViewById<SendboxDropDown>(Resource.Id.borderColorDropDown);
            _borderWidthDropDown = FindViewById<SendboxDropDown>(Resource.Id.borderWidthDropDown);
            _paddingTopDropDown = FindViewById<SendboxDropDown>(Resource.Id.paddingTopDropDown);
            _paddingBottomDropDown = FindViewById<SendboxDropDown>(Resource.Id.paddingBottomDropDown);
            _paddingLeftDropDown = FindViewById<SendboxDropDown>(Resource.Id.paddingLeftDropDown);
            _paddingRightDropDown = FindViewById<SendboxDropDown>(Resource.Id.paddingRightDropDown);
