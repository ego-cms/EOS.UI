...
namespace EOS.UI.Shared.Themes.Themes
{
    public partial class DarkEOSTheme
    {
        ...
        public Dictionary<string, object> ThemeValues => new Dictionary<string, object>()
        {
            ...
            { EOSConstants.DisabledSimpleButtonBackgroundColor, Color.ParseColor(neutralColor3)},
            ...
            { EOSConstants.FabIconColor, Color.ParseColor(neutralColor1)},
            ...
            { EOSConstants.R3C4,
                new FontStyleItem()
                {
                    Color = Color.ParseColor(neutralColor4),//should be #C0BFC0 in all themes
                    Typeface = RobotoMedium,
                    Size = 16f,
                    LetterSpacing = -0.01f,
                    LineHeight = 19f
